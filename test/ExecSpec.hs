...
bubbleSort :: [FInstr]
bubbleSort = [AddI {r = 12, x = 12, i = 11},Move {r = 0, from = 12},SubI {r = 0, x = 0, i = 5},StoreIdx {rsrc = 0, base = 14, offset = 5},LoadIdx {r = 0, base = 14, offset = 5},MoveI {r = 1, val = 4},StoreIdx {rsrc = 1, base = 0, offset = 0},MoveI {r = 1, val = 9},StoreIdx {rsrc = 1, base = 0, offset = 1},MoveI {r = 1, val = 1},StoreIdx {rsrc = 1, base = 0, offset = 2},MoveI {r = 1, val = 20},StoreIdx {rsrc = 1, base = 0, offset = 3},MoveI {r = 1, val = 3},StoreIdx {rsrc = 1, base = 0, offset = 4},MoveI {r = 0, val = 0},StoreIdx {rsrc = 0, base = 14, offset = 4},LoadIdx {r = 0, base = 14, offset = 4},MoveI {r = 1, val = 5},Lt {r = 0, x = 0, y = 1},BF {rsrc = 0, addr = 32},LoadIdx {r = 1, base = 14, offset = 5},LoadIdx {r = 2, base = 14, offset = 4},LoadBaseIdx {r = 1, base = 1, rOffset = 2},Print {rsrc = 1},LoadIdx {r = 1, base = 14, offset = 4},MoveI {r = 2, val = 1},Add {r = 1, x = 1, y = 2},StoreIdx {rsrc = 1, base = 14, offset = 4},LoadIdx {r = 0, base = 14, offset = 4},MoveI {r = 1, val = 5},Lt {r = 0, x = 0, y = 1},BT {rsrc = 0, addr = 20},PrintLn,MoveI {r = 0, val = 0},StoreIdx {rsrc = 0, base = 14, offset = 4},LoadIdx {r = 0, base = 14, offset = 4},MoveI {r = 1, val = 4},Lt {r = 0, x = 0, y = 1},BF {rsrc = 0, addr = 89},MoveI {r = 1, val = 0},StoreIdx {rsrc = 1, base = 14, offset = 2},LoadIdx {r = 1, base = 14, offset = 2},MoveI {r = 2, val = 4},Lt {r = 1, x = 1, y = 2},BF {rsrc = 1, addr = 81},LoadIdx {r = 2, base = 14, offset = 5},LoadIdx {r = 4, base = 14, offset = 2},MoveI {r = 5, val = 1},Add {r = 4, x = 4, y = 5},LoadBaseIdx {r = 2, base = 2, rOffset = 4},LoadIdx {r = 3, base = 14, offset = 5},LoadIdx {r = 4, base = 14, offset = 2},LoadBaseIdx {r = 3, base = 3, rOffset = 4},Lt {r = 2, x = 2, y = 3},BF {rsrc = 2, addr = 73},LoadIdx {r = 3, base = 14, offset = 5},LoadIdx {r = 4, base = 14, offset = 2},LoadBaseIdx {r = 3, base = 3, rOffset = 4},StoreIdx {rsrc = 3, base = 14, offset = 1},LoadIdx {r = 3, base = 14, offset = 5},LoadIdx {r = 4, base = 14, offset = 2},LoadIdx {r = 5, base = 14, offset = 5},LoadIdx {r = 6, base = 14, offset = 2},MoveI {r = 7, val = 1},Add {r = 6, x = 6, y = 7},LoadBaseIdx {r = 5, base = 5, rOffset = 6},StoreBaseIdx {rsrc = 5, base = 3, rOffset = 4},LoadIdx {r = 3, base = 14, offset = 5},LoadIdx {r = 4, base = 14, offset = 2},MoveI {r = 6, val = 1},Add {r = 4, x = 4, y = 6},LoadIdx {r = 5, base = 14, offset = 1},StoreBaseIdx {rsrc = 5, base = 3, rOffset = 4},LoadIdx {r = 2, base = 14, offset = 2},MoveI {r = 3, val = 1},Add {r = 2, x = 2, y = 3},StoreIdx {rsrc = 2, base = 14, offset = 2},LoadIdx {r = 1, base = 14, offset = 2},MoveI {r = 2, val = 4},Lt {r = 1, x = 1, y = 2},BT {rsrc = 1, addr = 45},LoadIdx {r = 1, base = 14, offset = 4},MoveI {r = 2, val = 1},Add {r = 1, x = 1, y = 2},StoreIdx {rsrc = 1, base = 14, offset = 4},LoadIdx {r = 0, base = 14, offset = 4},MoveI {r = 1, val = 4},Lt {r = 0, x = 0, y = 1},BT {rsrc = 0, addr = 39},MoveI {r = 0, val = 0},StoreIdx {rsrc = 0, base = 14, offset = 4},LoadIdx {r = 0, base = 14, offset = 4},MoveI {r = 1, val = 5},Lt {r = 0, x = 0, y = 1},BF {rsrc = 0, addr = 107},LoadIdx {r = 1, base = 14, offset = 5},LoadIdx {r = 2, base = 14, offset = 4},LoadBaseIdx {r = 1, base = 1, rOffset = 2},Print {rsrc = 1},LoadIdx {r = 1, base = 14, offset = 4},MoveI {r = 2, val = 1},Add {r = 1, x = 1, y = 2},StoreIdx {rsrc = 1, base = 14, offset = 4},LoadIdx {r = 0, base = 14, offset = 4},MoveI {r = 1, val = 5},Lt {r = 0, x = 0, y = 1},BT {rsrc = 0, addr = 95},SubI {r = 12, x = 12, i = 11},SysCall]
